...
<sup>Colourful is CLS Compliant (to allow use in VB.NET etc.) and is built for .NET Standard 1.1, .NET Standard 1.6, .NET Framework 4.5, and .NET 5. For .NET v4.0 see [version 1 of the library](https://github.com/tompazourek/Colourful/releases/tag/1.2.2).</sup>

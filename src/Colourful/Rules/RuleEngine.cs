...
namespace Colourful.Rules
{
    ...
    {
        public ChainNode(Type colorType, XYZColor? whitePoint = null, RGBPrimariesChromaticityCoordinates? rgbPrimaries = null, ICompanding companding = null)
        {
            ColorType = colorType;
        ...
        public RGBPrimariesChromaticityCoordinates? RGBPrimaries { get; }

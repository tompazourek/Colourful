    ...
    public class LChabConversionStrategy : IConversionStrategy
    {
            ...
            where TTarget : struct
        {
            ...
            if (typeof(TSource) == typeof(LChabColor))
            {
                ...
                var firstConversion = converterFactory.CreateConverter<TSource, LabColor>(in sourceNode, intermediateNode);
                var secondConversion = converterFactory.CreateConverter<LabColor, TTarget>(intermediateNode, in targetNode);

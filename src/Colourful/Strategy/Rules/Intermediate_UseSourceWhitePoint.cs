...
{
    public class Intermediate_UseSourceWhitePoint<TSource, TIntermediate, TTarget> : IConversionRule<TSource, TTarget>
        ...
        where TTarget : struct
    {
        ...
        public Intermediate_UseSourceWhitePoint(ConversionFactory conversionFactory)
        {

...
{
    public class Intermediate_UseTargetWhitePoint_UseSourceRGBPrimaries<TSource, TIntermediate, TTarget> : IConversionRule<TSource, TTarget>
        ...
        where TTarget : struct
    {
        ...
        public Intermediate_UseTargetWhitePoint_UseSourceRGBPrimaries(ConversionFactory conversionFactory)
        {
        ...
        {
            var intermediateNode = (IConversionMetadata)new ConversionMetadata(CreateWhitePoint(sourceNode.GetWhitePoint()), CreateRGBPrimaries(sourceNode.GetRGBPrimaries()));

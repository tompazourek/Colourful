...
{
    public class Intermediate_UseTargetWhitePoint<TSource, TIntermediate, TTarget> : IConversionRule<TSource, TTarget>
        ...
        where TTarget : struct
    {
        ...
        public Intermediate_UseTargetWhitePoint(ConversionFactory conversionFactory)
        {

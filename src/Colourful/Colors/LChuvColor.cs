...
namespace Colourful
{
    ...
    public readonly struct LChuvColor : IColorVector, IEquatable<LChuvColor>
    {
        ...
        public LChuvColor(in double l, in double c, in double h) : this(in l, in c, in h, in DefaultWhitePoint)
        {
        }
        ...
        public LChuvColor(in double l, in double c, in double h, in XYZColor whitePoint)
        {
            L = l;
            C = c;
            this.h = h;
        ...
        public LChuvColor(in double[] vector) : this(in vector, in DefaultWhitePoint)
        {
        }

        /// <param name="vector"><see cref="Vector" />, expected 3 dimensions</param>
        /// <param name="whitePoint">Reference white (see <see cref="Illuminants" />)</param>
        public LChuvColor(in double[] vector, in XYZColor whitePoint)
